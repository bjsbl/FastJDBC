 ...
 * 
 */
public class FastResultSet extends PoolableWrapper implements ResultSet {

	private final ResultSet resultSet;
	private final FastStatement statement;

	public FastResultSet(ResultSet resultSet, FastStatement statement) {
		super(resultSet);
